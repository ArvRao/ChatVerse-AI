                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    This is how your ChatVerse AI companion will be named.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormControl>
                                    <Input
                                        disabled={isLoading}
                                        placeholder="CEO of Tesla, SpaceX and many more..."
                                        {...field}
                                    />
                                </FormControl>
                                <FormDescription>
                    ...
                    <div className="space-y-2 w-full">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Detailed instructions for our AI behaviour
                            </p>
                        </div>
                        <Separator className="bg-primary/10" />
                    </div>
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    Describe in detail you Chatverse AI&apos;s backstory & relevant details.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
